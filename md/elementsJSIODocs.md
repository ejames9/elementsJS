# <a id='get-started'></a> <a id='installation'>Installation</a> 
...
## <a id='interpreter-install'>Installing the elementsJS Interpreter</a>   
...
# <a id='imports'>The imports() function</a> 
--
...
# <a id='DOM'>DOM Manipulation functions</a> 
--

## <a id='el-func'>`el(elem)`</a> 
...
## <a id='__-func'>`__(tempLit, elem='body')`</a> 
...
## <a id='make-func'>`make(elem, tag='div')`</a> 
...
## <a id='fore-func'>`fore(ref, elem)`</a> 
...
## <a id='show-func'>`show(elem, disp='block')`</a> 
...
## <a id='size-func'>`size(elem, h, w)`</a> 
...
# <a id='event-handle'>Event Handling Functions</a> 
...
## <a id='on-func'>`on(event, el, callback)`</a> 
...
## <a id='off-func'>`off(event, el, callback)`</a> 
...
```
## <a id='once-func'>`once(event, el, callback)`</a> 
...
## <a id='spark-func'>`spark(event, elem)`</a> 
...
go(spark('focus', '#foo'));
```
## <a id='click-func'>`click(elem, cb=null)`</a> 
...
## <a id='dblClick-func'>`dblClick(elem, cb=null)`</a> 
...
## <a id='blur-func'>`blur(elem, cb=null)`</a> 
...
## <a id='error-func'>`error(elem, cb=null)`</a> 
...
## <a id='focus-func'>`focus(elem, cb=null)`</a> 
...
## <a id='focusIn-func'>`focusIn(elem, cb=null)`</a> 
...
## <a id='focusOut-func'>`focusOut(elem, cb=null)`</a> 
...
## <a id='keyUp-func'>`keyUp(elem, cb=null)`</a> 

Same as above, but for the `'keyup'` event.


## <a id='keyDown-func'>`keyDown(elem, cb=null)`</a> 

Same as above, but for the `'keydown'` event.

## <a id='load-func'>`load(elem, cb=null)`</a> 

Same as above, but for the `'load'` event.

## <a id='unLoad-func'>`unLoad(elem, cb=null)`</a> 

Same as above, but for the `'unload'` event.

## <a id='mouse-func'>`mouse(elem, cb=null)`</a> 

Same as above, but for the `'mouse'` event.

## <a id='resize-func'>`reSize(elem, cb=null)`</a> 

Samesies, but for the `'resize'` event.

## <a id='scroll-func'>`scroll(elem, cb=null)`</a> 

Samesies, but for the `'scroll'` event.

## <a id='select-func'>`select(elem, cb=null)`</a> 

Samesies, but for the `'select'` event.

# <a id='http'>HTTP Requests</a> 
--
...
## <a id='xhr-func'>`xhr(url, fd, method='GET')`</a> 
...
## <a id='ajax-func'>`ajax(url, fd, callback(r), method='GET')`</a> 
...
# <a id='loggers'>Logging Functions</a> 
--
...
## <a id='log-func'>`log(text, style, time)`</a> 
...
## <a id='info-func'>`info(text, time)`</a> 
...
## <a id='warn-func'>`warn(text, time)`</a> 
...
# <a id='utils'>Utility Functions</a> 
...
## <a id='proto-func'>`proto(constructer, superConstructer)`</a> 
...
## <a id='shifter-func'>`shifter(onFunc, offFunc)`</a> 
...
# <a id='elem-obj'>The element Object</a> 
...
## <a id='element-const'>`element(elem)`</a> 
...
## <a id='dom2-func'> `dom(elem)` </a>

## <a id='make2-func'>`make(elem, tag='div' )`</a> 
...
# <a id='elem-obj-methods'>element Object Methods</a> 
--
...
## <a id='element-font-ex'>`element.font(value)`</a> 
...
## <a id='style-methods'>Style Methods</a> 
...
# <a id='core-func'>`element.core(func, obj='el')`</a> 
--
...
## <a id='DOM-Elem-Methods'>DOM Element Methods</a> 
...
## <a id='event-methods'>Event Methods</a> 
...
## <a id='Util-Methods'>Utility Methods</a> 
...
# <a id='elements-syntax'>The elementsJS <span id='elSynSpan'>elements</span> Syntax</a> 
...
## <a id='elemsyntax-func1'>`<elem>`, `<tag=elem>`</a> 
...
## <a id='elemsyntax-func3'>`<elem=num/>`</a> 
...
## <a id='elemsyntax-func4'>`<tag=elem/>`</a> 
...
## <a id='elemsyntax-func5'>`<tag=elem=num/>`</a> 
...
## <a id='elemsyntax-func6'>`<tag/>`, `<tag=num/>`</a> 
...
```
## <a id='append-syntax'>What If I Want to Append to an Element other than the `<body>`?</a> 
...
## <a id='elemsyntax-func7'>`<'#footer'<ol='#list'<li='.item'=3/>/>/>`</a> 
