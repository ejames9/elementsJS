...
*/
  ...
  this.scrolled = function() {                                                  //TODO
    let r = this.el.scrollTop;

    return r;
  };

  this.scrollLeft = function() {                                                  //TODO
    let r = this.el.scrollLeft;

    return r;
  };

  this.scrollHeight = function() {                                                  //TODO
    let r = this.el.scrollLeft;

    return r;
  };

  this.scrollWidth = function() {                                                  //TODO
    let r = this.el.scrollWidth;
